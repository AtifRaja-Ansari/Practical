...
public class LinkedListMethod { // class
	...
	public static void main(String[] args) { // main method
		...
		// Retrieving the 1st element of list by default using peek() method

		System.out.println(l.peek());
		// Retrieving the 1st element of list
		System.out.println(l.peekFirst());
		// Retrieving the last element of list
		System.out.println(l.peekLast());

		// Retrieve and remove 1st element by default using poll() method
		System.out.println(l.poll());
		System.out.println("New list 1 element: " + l);
		// Retrieve and remove 1st element
		System.out.println(l.pollFirst());
		System.out.println("New list 1 element: " + l);
		// Retrieve and remove last element by default
